	...
	<script type="mime" src="http://cidades-estados-js.googlecode.com/files/cidades-estados-v0.2.js"></script>
    ...
    <script type="text/javascript" src="../<%=Constants.JS%>/bootstrap-datepicker.js"></script>
