			...
			<div class="modal-body">
				<div class="form-group">
					<div>
						...
						<input type="password" value="" class="form-control" id="senhaAtual" name="senhaAtual" />
					</div>
					<div>
						<label for="novaSenha" class="control-label">Nova senha:</label> 
						<input type="password" value="" class="form-control" id="novaSenha" name="novaSenha" />
					</div>
					<div>
						<label for="confirmacaoSenha" class="control-label">Confirmação nova senha:</label> 
						<input type="password" value="" class="form-control" id="confirmacaoSenha" name="confirmacaoSenha" />
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal" id="fechar">Alterar</button>
			</div>
		</div>
	</div>
</div>
