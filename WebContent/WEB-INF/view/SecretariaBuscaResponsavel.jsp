						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="box-name">
										<i class="fa  fa-info-circle"></i> <span>Respons�veis</span>
									</div>
									<div class="box-icons">
											...
											<c:forEach var="responsavel" items="${listaResponsaveis}">
												<tr>
													...
													<td class="text-center" width="5%">
														...
														data-confirm="Deseja realmente editar o respons�vel selecionado?">Editar</a>
													</td>
													<td class="text-center" width="5%">
													...
													<td class="text-center" width="5%">
														...
														data-confirm="Deseja realmente excluir o respons�vel selecionado?">Deletar</a>
													</td>
