											...
											<c:forEach var="atleta" items="${listaAtletas}">
												<tr>
													...
													<c:if test="${atleta.flCadastroAtivo == 1}">
														...
														<td align="center">
															<a class="link-green" id="emprestimo" href="SecretariaController?action=jspGerenciarRetirada&idPessoa=${atleta.idPessoa}&nome=${atleta.nome}"><abbr title="Retirada de uniformes"><i class="fa fa-large fa-tags"></i></abbr></a>
														</td>
														<td align="center">	
