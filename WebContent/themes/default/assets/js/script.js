...
function editarDieta(idDieta) {
	...
	$.ajax({
		...
		success : function(data) {
			...
			+ "<div class='col-sm-12'>"
				if (data.competicao) {
					"<label style='padding: 5px 22px 5px 0;'><input type='checkbox' name='competicao' value='true' checked='checked'> Per�odo de competi��o</label>"
				} else {
					"<label style='padding: 5px 22px 5px 0;'><input type='checkbox' name='competicao' value='true'> Per�odo de competi��o</label>"
				}
            + "</div>"
