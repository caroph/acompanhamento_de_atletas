...
public class UsuarioNegocio {
		...
		try {
			if (dao.esqueciSenha(emailSenha, novaSenhaCrip)) {
				try {
					...
					retorno = "Em instantes vocÃª receberá um email com sua nova senha!";
				} catch (Exception e) {
	...
	public boolean inserir(Usuario usuario) throws Exception{
		...
		try {
			...
			throw new Exception("Erro! Ocorreu algum erro ao inserir o usuário");
		}
	...
	public List<Usuario> buscarUsuarios() throws Exception{
		try {
			...
			throw new Exception("Erro! Ocorreu algum erro ao buscar os usuários");
		}
	}
	...
	public boolean alterar(Usuario usuario) throws Exception {
		try {
			...
			throw new Exception("Erro! Ocorreu algum erro ao alterar o usuário");
		}
		return false;
	}
	...
	public String verificarSenha(String senhaAtual, String novaSenha,
		...
		if("".equals(senhaAtual)){
			...
			return "Preencha a confirmaÃ§Ã£o de senha!";
		}else if(!novaSenha.equals(confirmacaoSenha)){
			return "A confirmaÃ§Ã£o deve ser igual a senha!";
		}else{
			try{
				UsuarioDAO dao = new UsuarioDAO();
	...
	public List<Integer> buscarIdUsuarios(int compartilhar) throws Exception {
		try {
			...
			throw new Exception("Erro! Ocorreu algum erro ao buscar os usuário para compartilhamento!");
		}
	}
}
