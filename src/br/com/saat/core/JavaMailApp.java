...
public class JavaMailApp {
    ...
    public void enviaEmail(String email, String novaSenha, int tipo) throws AddressException, MessagingException {
        ...
        if(tipo == 1){
        	...
        	message.setSubject("SAAT - Usu·rio criado");//Assunto
            message.setText("Bem vindo(a) ao SAAT - Sistema de Acompanhamento de Atletas de TÍnis!\n\n"
            		+ "Sua senha de acesso ao sistema È: " + novaSenha + "\n\n"
    				+ "Favor alter·-la o mais breve possÌvel!\n\n"
            		+ "http://191.252.0.97:8080/saat_homolog/ \n\n"
            		+ "Atenciosamente, \n"
    				+ "SAAT - Sistema de Acompanhamento de Atleta de TÍnis");
