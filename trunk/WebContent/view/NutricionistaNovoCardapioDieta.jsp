				...
				<div class="row clearfix">
					...
					<div class="col-md-12" style="margin:10px 0px 10px 0px;">
						<div class="col-md-6">
							<div class="col-md-5 text-left">
								<label for="periodoCompeticao" class="control-label text-left">Periodo de Competição</label>
							</div>
							<div class="col-md-4">
								<input type="radio" id="rdCompeticao" name="rdCompeticao" value="s"/> Sim
								<input type="radio" id="rdCompeticao2" name="rdCompeticao" value="n" checked="checked" style="margin-left: 10px;"/> Não
							</div>
						</div>
					</div>
					<div class="col-md-12" style="margin:10px 0px 10px 0px;">
					...
					<div class="col-md-12" style="margin:10px 0px 10px 0px;">
						<div class="col-md-6 text-left">
							<label for="periodoValidade" class="control-label text-left">Alimentos Atualmente no Cardápio</label>
						</div>
						<div class="col-md-6">
							<div class="col-md-6 text-left">
								<label for="periodoValidade" class="control-label text-left">Alimentos Disponíveis</label>
							</div>
							<div class="col-md-6 text-right">
								<a href="#">Adicionar Alimentos à Lista</a>
							</div>
						</div>
					</div>
