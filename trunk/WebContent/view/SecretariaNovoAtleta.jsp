				...
				<div class="row clearfix">
					...
					<div class="col-md-10 column">
						...
						<form class="form-horizontal" role="form">
							...
							<div class="form-group">
								<label for="nr" class="col-sm-4 control-label">N.º Matrícula Clube Curitibano:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="inputEmail3" />
								</div>
							</div>
							<div class="form-group">
								<label for="nr" class="col-sm-4 control-label">N.º Cadastro FPT:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="inputEmail3" />
								</div>
							</div>
							<div class="form-group">
								<label for="nr" class="col-sm-4 control-label">N.º Cadastro CBT:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="inputEmail3" />
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10 text-right">
									<!-- <button type="button" class="btn btn-primary" id="vincular">Vincular Responsável</button> -->
